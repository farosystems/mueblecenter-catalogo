...
interface PresentacionPageProps {
  params: Promise<{
    presentacion: string
  }>
}

export default function PresentacionPage({ params }: PresentacionPageProps) {
  ...
  // Cargar presentaciones y productos
  useEffect(() => {
    ...
    loadData()
  }, [resolvedParams.presentacion, zonaSeleccionada?.id])
        ...
        <div className="bg-gradient-to-br from-gray-50 to-blue-50 min-h-screen">
          ...
          <div className="flex items-center justify-center py-20" style={{ marginTop: '140px' }}>
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600">La presentación "{resolvedParams.presentacion}" no existe</p>
            </div>
          </div>
          <Footer />
        </div>
          ...
          {filteredProducts.length > 0 ? (
            ...
            <div className="text-center py-16">
              ...
              <p className="text-gray-500 mb-6">
                {searchTerm 
                  ? `No hay productos que coincidan con "${searchTerm}" en ${presentacion.nombre}`
                  : `No hay productos disponibles en ${presentacion.nombre}`
                }
              </p>
              {searchTerm && (
                <button
